...
use widgetry::{
    lctrl, Choice, Color, Drawable, EventCtx, GeomBatch, GfxCtx, HorizontalAlignment, Key, Outcome,
    Panel, State, Text, TextExt, TextSpan, VerticalAlignment, Widget,
};
        ...
        ctx.loading_screen("load kml", |ctx, mut timer| {
            ...
            Box::new(ViewKML {
                ...
                panel: Panel::new(Widget::col(vec![
                    Widget::row(vec![
                        "KML viewer".span().small_heading().into_widget(ctx),
