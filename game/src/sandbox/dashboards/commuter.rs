...
use widgetry::{
    ...
    RewriteColor, Slider, State, Text, TextExt, TextSpan, Toggle, VerticalAlignment, Widget,
};
            ...
            Some(base_block_id) => {
                ...
                match block_selection {
                    BlockSelection::Locked {
                        ...
                        let label = Text::from(TextSpan::new(label_text).fg(Color::BLACK))
